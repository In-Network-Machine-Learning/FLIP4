...
def run_model(train_X, train_y, test_X, test_y, used_features):
    ...
    Planter_config['model config']['number of depth'] = int(input('- Number of depth? (defalt = 4) ') or '4')
    Planter_config['model config']['max number of leaf nodes'] = int(input('- Number of leaf nodes? (defalt = 1000) ') or '1000')
