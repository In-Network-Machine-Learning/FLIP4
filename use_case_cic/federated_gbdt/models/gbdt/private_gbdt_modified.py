        ...
        if (node_total_hess >= self.min_child_weight or split_method == "totally_random") and (current_depth < self.max_depth):
            ...
            if split_data:
                ...
                if largest_score > self.reg_gamma:
                    ...
                    print("DEBUG chosen_feature: ", chosen_feature)
                    print("DEBUG current_depth: ", current_depth)
                    print("DEBUG left_branch.value: ", left_branch.value)
                    print("DEBUG right_branch.value: ", right_branch.value)
