...
class PrivacyAccountant():
    ...
    def gaussian_var(self, depth, gradient_type="gradient", feature=None, adaptive_hessian=False):
        ...
        depth = max(0,depth)
        # if self.current_tree > 4:
        #     self.current_tree = self.current_tree - 5
        # self.current_tree = self.current_tree # MING DEBUG accuracy is higher with -1, no -1 can work but lower acc???
        # print('Retrieve sigma depth: ', depth)
        # print('Retrieve sigma self.current_tree: ', self.current_tree)
        # print('Retrieve sigma grad_type: ', grad_type)
